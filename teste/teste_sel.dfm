inherited formSelTeste: TformSelTeste
  Caption = 'Cadastro Teste'
  PixelsPerInch = 96
  TextHeight = 13
  inherited dxRibbonSel: TdxRibbon
    inherited dxRibbonSelTabCadastro: TdxRibbonTab
      Index = 0
    end
    inherited dxRibbonSelTabExportar: TdxRibbonTab
      Index = 1
    end
    inherited dxRibbonSelTabAvancado: TdxRibbonTab
      Index = 2
    end
  end
  inherited pnlSel: TPanel
    TabOrder = 6
    inherited imgSelFiltro: TcxImage
      Picture.Data = {
  ...
  inherited gridSel: TcxGrid
    ExplicitTop = 184
    ExplicitHeight = 317
    inherited gridSelDBTableView1: TcxGridDBTableView
      DataController.DataSource = dataTeste.dsrSel
      object gridSelDBTableView1CODIGO: TcxGridDBColumn
        DataBinding.FieldName = 'CODIGO'
        Width = 96
      end
      object gridSelDBTableView1NOME: TcxGridDBColumn
        DataBinding.FieldName = 'NOME'
        Width = 366
      end
      object gridSelDBTableView1FONE: TcxGridDBColumn
        DataBinding.FieldName = 'FONE'
      end
    end
  end
  inherited dxBarManSel: TdxBarManager
    DockControlHeights = (
      0
      0
      0
      0)
    inherited dxBarManSelBarOperacoes: TdxBar
      DockedDockControl = nil
      DockedDockingStyle = dsNone
      FloatClientWidth = 51
      FloatClientHeight = 169
    end
    inherited dxBarManSelBarSelecionar: TdxBar
      DockedDockControl = nil
      DockedDockingStyle = dsNone
      FloatClientWidth = 72
      FloatClientHeight = 162
    end
    inherited dxBarManSelBarExportar: TdxBar
      DockedDockControl = nil
      DockedDockingStyle = dsNone
      FloatClientWidth = 62
      FloatClientHeight = 216
    end
    inherited dxBarManSelBarAvancado: TdxBar
      DockedDockControl = nil
      DockedDockingStyle = dsNone
      FloatClientWidth = 65
